        ...
        for line in file:
            if line.strip():
                try:
                    ...
                    dependencies.append(notebook.Dependency(package=package, version=version))
                except:
                    package = line.strip()
                    dependencies.append(notebook.Dependency(package=package, version=""))
...
async def dependency_update(dependency_request: request.DependencyRequest, websocket: WebSocket):
    try:
