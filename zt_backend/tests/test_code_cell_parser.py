...
def test_no_dependencies():
    cells = Request(originId="0", cells=[CodeRequest(id="0",code="a = 1", variable_name="", cellType='code'),
                           CodeRequest(id="1",code="b = 2", variable_name="", cellType='code'),
                           CodeRequest(id="2",code="c = 3", variable_name="", cellType='code')],\
                    components={"":""})
...
def test_simple_dependencies():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="a = 1", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="b = a + 2", variable_name="", cellType='code'),
                           CodeRequest(id="2", code="c = b + 3", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_complex_dependencies():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="a = 1", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="b = a + 2", variable_name="", cellType='code'),
                           CodeRequest(id="2", code="c = b + a", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_overriding_dependencies():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="a = 1", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="b = a + 2", variable_name="", cellType='code'),
                           CodeRequest(id="2", code="a = 3", variable_name="", cellType='code'),
                           CodeRequest(id="3", code="c = a + b", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_function_definitions_and_calls():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="def f(x): return x + 2", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="a = f(2)", variable_name="", cellType='code'),
                           CodeRequest(id="2", code="b = a + 3", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_dependencies_with_function_calls_and_redefinitions():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="def f(x): return x + 2", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="a = f(2)", variable_name="", cellType='code'),
                           CodeRequest(id="2", code="b = a + 3", variable_name="", cellType='code'),
                           CodeRequest(id="3", code="def g(x): return x * 2", variable_name="", cellType='code'),
                           CodeRequest(id="4", code="c = g(b)", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_importing_module():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="import math", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="a = math.sqrt(4)", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_multiple_variables_in_one_cell():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="a = 1; b = 2; c = 3", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="d = a + b + c", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
...
def test_importing_module_with_alias():
    cells = Request(originId="0", cells=[CodeRequest(id="0", code="import math as m", variable_name="", cellType='code'),
                           CodeRequest(id="1", code="a = m.sqrt(4)", variable_name="", cellType='code')],
                    components={})
    cell_dict = build_dependency_graph(parse_cells(cells))
