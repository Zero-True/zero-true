...
class iFrame(ZTComponent):
    ...
    width: Union[int,str] = Field('w-auto', description="Width of the iframe")
    height: Union[int,str] = Field('h-auto', description="Height of the iframe")
    ...
    allowtransparency: bool = Field(False, description="Allow transparency of the iframe")