...
class Autocomplete(ZTComponent):
    ...
    label: Optional[str] = Field("", description="Label for the autocomplete box")
    multiple: Optional[bool] = Field(False, description="Determines if multiple selections are allowed")
    clearable: Optional[bool] = Field(True, description="Determines if the autocomplete box has a clearable option")
    disabled: Optional[bool] = Field(False, description="Determines if the autocomplete box is disabled")
    readonly: Optional[bool] = Field(False, description="Determines if the autocomplete box is read-only")
    color: Optional[str] = Field("primary", pre=True, description="Color of the autocomplete component. Can be custom or standard Material color")
