...
import CopilotComponent from "@/components/plugins/CopilotComponent.vue";
import ShareComponent from "@/components/plugins/ShareComponent.vue";
...
import SidebarComponent from "@/components/file-system/FileExplorer.vue";
